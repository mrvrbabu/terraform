...
variable "vpc_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "enterprise-client-vpc", "created-by" = "terraform" }
}
...
variable "asg_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "enterprise-asg-sg", "created-by" = "terraform" }
}

variable "asg_name" {
  description = "Name of the autoscaling group"
  type        = string
  default     = "enterprise-asg"
}
...
variable "asg_iam_role_name" {
  ...
  type        = string
  default     = "enterprise-asg-iam-role"
}
...
variable "asg_iam_role_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "enterprise-asg-iam-role", "created-by" = "terraform" }
}
...
variable "asg_instance_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "enterprise-asg-instance", "created-by" = "terraform" }
}

variable "asg_volume_tags" {
  description = "Auto scaling group volume tags"
  type        = map(string)
  default     = { "Name" = "enterprise-asg-volume", "created-by" = "terraform" }
}

variable "asg_tags" {
  description = "Auto scaling group tags"
  type        = map(string)
  default     = { "Name" = "enterprise-asg", "created-by" = "terraform" }
}
...
variable "alb_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "enterprise-alb-sg", "created-by" = "terraform" }
}

variable "alb_description" {
  description = "Application load balancer description"
  type        = string
  default     = "enterprise-alb"
}
...
variable "alb_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "enterprise-alb", "created-by" = "terraform" }
}
...
variable "rds_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "enterprise-rds-sg", "created-by" = "terraform" }
}

variable "rds_identifier" {
  description = "Relational database service identifier"
  type        = string
  default     = "enterprise-rds"
}
...
variable "rds_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "enterprise-rds", "created-by" = "terraform" }
}
